...
| RST             | RST                       | Computer                   | 2DO Reset asincrono del computer; [spiegazione](../loader/#caricamento-di-un-programma).                                                                  |
| LDR-ACTIVE      | LDR-Active                | Loader → Clock e → CL      | 2DO Disattivazione clock e EEPROM Control Logic; [spiegazione](../loader/#caricamento-di-un-programma).                                                   |
| LDR-CLK         | LDR-CLK                   | Loader → Clock             | 2DO Iniezione del clock del Loader nel computer; [spiegazione](../loader/#caricamento-di-un-programma).                                                   |
| CLK-Start       | CLK-Start                 | Loader → Clock             | 2DO (Re-)Start del clock di sistema dopo il caricamento del programma in RAM; [spiegazione](../loader/#caricamento-di-un-programma).                      |
