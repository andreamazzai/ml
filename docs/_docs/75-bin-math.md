...
![Rappresentazione Modulo e Segno dei numeri a 4 bit](../../assets/math/75-math_signed_magnitude.gif){:width="80%"}
...
![Rappresentazione in Complemento di 2 dei numeri a 4 bit](../../assets/math/75-math_2c.gif){:width="80%"}
