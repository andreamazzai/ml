...
4. The need to learn at least the basics of C, which was used to create the [EEPROM programmer](docs/eeprom-programmer/) and the Arduino-based [Loader](/en/docs/loader/).
